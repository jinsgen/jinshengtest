...
# -----------------------
HEADER_HTML = """
<header style="background: rgba(109, 142, 199, 0.6); padding:15px 30px; color:white; display:flex; flex-wrap:wrap; justify-content:space-between; align-items:center; position:relative; z-index:999;">
...
<head>
  ...
  <style>
    ...
    /* 把 banner 拉到 header 底下 */
    .banner {{
      position: relative;
      margin-top: -90px;          /* 負外距，往上移 header 高度 */
      padding-top: 90px;          /* 上內距，騰出 header 空間 */
      height: 390px;              /* 原本 300 + 90 header */
